...
//we pass the data as a props:
// distructure the prop:
const Hero = ({
  heroapi: { title, subtitle, img, btntext, videos, sociallinks },
}) => {
  return (
    <>
      <div className="position-relative h-auto w-auto flex flex-col">
        <div className="bg-theme clip-path h-[85vh] lg:h-[75vh] md:h-[65vh] sm:h-[55vh] w-auto absolute top-0 left-0 right-0 opacity-100 z-10"></div>
        <div className="relative opacity-100 z-20 nike-container justify-items-center items-center grid">
